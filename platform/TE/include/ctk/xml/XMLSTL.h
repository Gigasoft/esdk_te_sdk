...
namespace xml {
    ...
    template<class K, class V>
    void operator>>(const XMLInStream& _xis, std::pair<K,V>& _v)
    {
    ...
    template<class K, class V>
    void operator>>(const XMLInStream& _xis, std::pair<const K,V>& _v)
    {
        std::istringstream iss(_xis.attr("__key__").value());
    ...
    template<class T>
    void operator>>(const XMLInStream& _xis, vector<T>& _v)
    {
        _v.clear();
        _xis.input(std::back_inserter(_v));
    }
    ...
    template<class T>
    void operator>>(const XMLInStream& _xis, deque<T>& _v)
    {
        _v.clear();
        _xis.input(std::back_inserter(_v));
    }
    ...
    template<class T>
    void operator>>(const XMLInStream& _xis, queue<T>& _v)
    {
        _v.clear();
        _xis.input(std::back_inserter(_v));
    }
    ...
    template<class T>
    void operator>>(const XMLInStream& _xis, stack<T>& _v)
    {
        _v.clear();
        _xis.input(std::back_inserter(_v));
    }
    ...
    template<class T>
    void operator>>(const XMLInStream& _xis, list<T>& _v)
    {
        _v.clear();
        _xis.input(std::back_inserter(_v));
    }
    ...
    template<class K, class V>
    void operator>>(const XMLInStream& _xis, map<K, V>& _v)
    {
        _v.clear();
        _xis.input(ctk::random_inserter(_v));
    }
    ...
    template<class K, class V>
    void operator>>(const XMLInStream& _xis, multimap<K, V>& _v)
    {
        _v.clear();
        _xis.input(ctk::random_inserter(_v));
    }
