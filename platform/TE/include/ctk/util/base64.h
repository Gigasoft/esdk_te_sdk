...
namespace ctk
{
    ...
    public:
        ...
        //CTK_STATIC_FUN String encode(istr _bin);
        //CTK_STATIC_FUN String encode(const std::vector<byte>& _bin);
        CTK_STATIC_FUN void encode(istr _bin, String& _txt);
        CTK_STATIC_FUN void encode(const ByteVector& _bin, String& _txt);

        //CTK_STATIC_FUN std::vector<byte> decode(const String& _txt);
