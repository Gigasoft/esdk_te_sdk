...
namespace ctk
{
    ...
    template<class _Ty, class _Container > inline void swap(stack<_Ty, _Container>& _l, stack<_Ty, _Container>& _r)
    {
        _l.swap(_r);
    }
    ...
    public:
        ...
        explicit random_insert_iterator(_Container& __x) : container(&__x)
        {
        }
        ...
        random_insert_iterator<_Container>& operator*()
        {
            return *this;
        }
        random_insert_iterator<_Container>& operator++()
        ...
        random_insert_iterator<_Container>  operator++(int)
        {
            return *this;
        }
    };

    template <class _Container> inline random_insert_iterator<_Container>  CTK_CALL
    ...
    public:
        ...
        explicit pair_update_iterator(_Container& __x) : container(&__x)
        {
        }
    ...
    template <class _Container> inline pair_update_iterator<_Container>  CTK_CALL
