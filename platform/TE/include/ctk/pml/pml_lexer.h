                    ...
                    while (true)
                    {
                        ...
                        if (impl_->__skip_blank(c0))
                        {
                            if (Const<CHAR_TYPE>::STR_TAG1_CHAR==c0 || Const<CHAR_TYPE>::STR_TAG2_CHAR==c0)
                            {
								...
								//Begin Added By hKF68714 2014/03/26 Reason: TQE eSpace for TP V100R001C01
								if ( 0 <= (_token.length()-1))
								{
									 (void)_token.erase(_token.length() - 1);
								}
								//End Added By hKF68714 2014/03/26 Reason: TQE eSpace for TP V100R001C01
                                continue;
                            } //if (Const<CHAR_TYPE>::STR_TAG1_CHAR==c0 || Const<CHAR_TYPE>::STR_TAG2_CHAR==c0)
